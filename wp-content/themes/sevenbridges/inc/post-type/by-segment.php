<?php 
// Register By Segment Post Type
function segment_post_type() {

	$labels = array(
		'name'                  => _x( 'By Segment', 'Post Type General Name', 'sevenBridges' ),
		'singular_name'         => _x( 'By Segment', 'Post Type Singular Name', 'sevenBridges' ),
		'menu_name'             => __( 'By Segment', 'sevenBridges' ),
		'name_admin_bar'        => __( 'By Segment', 'sevenBridges' ),
	...
	$args = array(
		'label'                 => __( 'By Segment', 'sevenBridges' ),
		'description'           => __( 'By Segment Description', 'sevenBridges' ),
		'labels'                => $labels,
	...
	register_post_type( 'by-segment', $args );

}
add_action( 'init', 'segment_post_type', 0 );
