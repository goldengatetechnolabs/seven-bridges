<?php 
// Register supports Post Type
function supports_post_type() {

	$labels = array(
		'name'                  => _x( 'supports', 'Post Type General Name', 'sevenBridges' ),
		'singular_name'         => _x( 'supports', 'Post Type Singular Name', 'sevenBridges' ),
		'menu_name'             => __( 'supports', 'sevenBridges' ),
		'name_admin_bar'        => __( 'supports', 'sevenBridges' ),
	...
	$args = array(
		'label'                 => __( 'supports', 'sevenBridges' ),
		'description'           => __( 'supports Description', 'sevenBridges' ),
		'labels'                => $labels,
