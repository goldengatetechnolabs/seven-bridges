<?php 
// Register Release Note Post Type
function release_notes_post_type() {

	$labels = array(
		'name'                  => _x( 'Release Notes', 'Post Type General Name', 'sevenBridges' ),
		'singular_name'         => _x( 'Release Note', 'Post Type Singular Name', 'sevenBridges' ),
		'menu_name'             => __( 'Release Notes', 'sevenBridges' ),
		'name_admin_bar'        => __( 'Release Note', 'sevenBridges' ),
	...
	$args = array(
		'label'                 => __( 'Release Note', 'sevenBridges' ),
		'description'           => __( 'Release Note Description', 'sevenBridges' ),
		'labels'                => $labels,
		'supports' => array('title', 'editor', 'excerpt', 'thumbnail', 'revisions', 'author', 'comments', 'trackbacks', 'page-attributes', 'post-formats', 'custom-fields'),
		'taxonomies'            => array( 'release-note', ),
		'hierarchical'          => false,
		'public'                => true,
		'show_ui'               => true,
		'show_in_menu'          => true,
...
add_action( 'init', 'release_notes_post_type', 0 );
