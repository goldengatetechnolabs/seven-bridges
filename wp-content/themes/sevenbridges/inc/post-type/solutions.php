...
function solution_post_type() {
	...
	$labels = array(
		'name'                  => _x( 'Solution', 'Post Type General Name', 'sevenBridges' ),
		'singular_name'         => _x( 'Solution', 'Post Type Singular Name', 'sevenBridges' ),
		'menu_name'             => __( 'Solution', 'sevenBridges' ),
		'name_admin_bar'        => __( 'Solution', 'sevenBridges' ),
	...
	$args = array(
		'label'                 => __( 'Solution', 'sevenBridges' ),
		'description'           => __( 'Solution Description', 'sevenBridges' ),
		'labels'                => $labels,
		...
		'menu_position'         => 3,
		//'rewrite' => array('slug' => 'solution/%solutions%', 'with_front' => false),
