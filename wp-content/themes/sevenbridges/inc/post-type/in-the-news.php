...
function news_post_type() {
	...
	$labels = array(
		'name'                  => _x( 'News', 'Post Type General Name', 'sevenBridges' ),
		'singular_name'         => _x( 'News', 'Post Type Singular Name', 'sevenBridges' ),
		'menu_name'             => __( 'News', 'sevenBridges' ),
		'name_admin_bar'        => __( 'News', 'sevenBridges' ),
	...
	$args = array(
		'label'                 => __( 'News', 'sevenBridges' ),
		'description'           => __( 'News Description', 'sevenBridges' ),
		'labels'                => $labels,
