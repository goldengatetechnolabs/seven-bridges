<?php 
// Register Insight Post Type
function insight_post_type() {

	$labels = array(
		'name'                  => _x( 'Insights', 'Post Type General Name', 'sevenBridges' ),
		'singular_name'         => _x( 'Insight', 'Post Type Singular Name', 'sevenBridges' ),
		'menu_name'             => __( 'Insights', 'sevenBridges' ),
		'name_admin_bar'        => __( 'Insight', 'sevenBridges' ),
	...
	$args = array(
		'label'                 => __( 'Insight', 'sevenBridges' ),
		'description'           => __( 'Insight Description', 'sevenBridges' ),
		'labels'                => $labels,
