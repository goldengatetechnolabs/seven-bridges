...
function leadership_post_type() {
	...
	$labels = array(
		'name'                  => _x( 'Leadership', 'Post Type General Name', 'sevenBridges' ),
		'singular_name'         => _x( 'Leadership', 'Post Type Singular Name', 'sevenBridges' ),
		'menu_name'             => __( 'Leadership', 'sevenBridges' ),
		'name_admin_bar'        => __( 'Leadership', 'sevenBridges' ),
	...
	$args = array(
		'label'                 => __( 'Leadership', 'sevenBridges' ),
		'description'           => __( 'Leadership Description', 'sevenBridges' ),
		'labels'                => $labels,
