...
function events_post_type() {
	...
	$labels = array(
		'name'                  => _x( 'Events', 'Post Type General Name', 'sevenBridges' ),
		'singular_name'         => _x( 'Event', 'Post Type Singular Name', 'sevenBridges' ),
		'menu_name'             => __( 'Events', 'sevenBridges' ),
		'name_admin_bar'        => __( 'Event', 'sevenBridges' ),
	...
	$args = array(
		'label'                 => __( 'Event', 'sevenBridges' ),
		'description'           => __( 'Event Description', 'sevenBridges' ),
		'labels'                => $labels,
