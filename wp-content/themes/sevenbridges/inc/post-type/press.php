...
function press_post_type() {
	...
	$labels = array(
		'name'                  => _x( 'Press', 'Post Type General Name', 'sevenBridges' ),
		'singular_name'         => _x( 'Press', 'Post Type Singular Name', 'sevenBridges' ),
		'menu_name'             => __( 'Press', 'sevenBridges' ),
		'name_admin_bar'        => __( 'Press', 'sevenBridges' ),
	...
	$args = array(
		'label'                 => __( 'Press', 'sevenBridges' ),
		'description'           => __( 'Press Description', 'sevenBridges' ),
		'labels'                => $labels,
		'supports' => array('title', 'editor', 'excerpt', 'thumbnail', 'revisions', 'author', 'comments', 'trackbacks', 'page-attributes', 'post-formats', 'custom-fields'),
		'taxonomies'            => array( 'in-the-news', 'press-releases',),
		'hierarchical'          => false,
		'public'                => true,
		'show_ui'               => true,
		'show_in_menu'          => true,
