...
function blogs_post_type() {
	...
	$labels = array(
		'name'                  => _x( 'Blogs', 'Post Type General Name', 'sevenBridges' ),
		'singular_name'         => _x( 'Blog', 'Post Type Singular Name', 'sevenBridges' ),
		'menu_name'             => __( 'Blogs', 'sevenBridges' ),
		'name_admin_bar'        => __( 'Blog', 'sevenBridges' ),
	...
	$args = array(
		'label'                 => __( 'Blog', 'sevenBridges' ),
		'description'           => __( 'Blog Description', 'sevenBridges' ),
		'labels'                => $labels,
