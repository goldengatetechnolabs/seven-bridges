...
?>
<!-- Banner -->
<section class="banner-area inner-banner g-blue py-5 clearfix">
	<div class="container">
...
<!-- Welcome  -->
<section  class="welcome-area bg-33 text-white py-4 clearfix">
	<div class="container">
		<div class="row justify-content-center align-items-center">
...
<!-- Welcome  -->
<section  class="welcome-area bg-f4 py-5 clearfix">
    <?php if (have_rows('modular_solution')) : while (have_rows('modular_solution')) : the_row(); ?>
        <div class="container py-md-4">
            <div class="section-title mb-4 text-center">
                <div class="line mb-4"></div>
                <h2 class="mb-4"><?php echo get_sub_field('title'); ?></h2>
                <p class="mb-0 col-md-8 mx-auto"><?php echo get_sub_field('description'); ?></p>
            </div>
            <div class="row justify-content-center align-items-center">
                            ...
                            <div class="col-md-6">
                                <div class="ic-block">
                                    <div class="row justify-content-center">
                                        <div class="col-md-4">
                                            <div class="ic-img"><img src="<?php echo get_sub_field('icon'); ?>" class="img-fluid"></div>
                                        </div>
                                        <div class="col-md-8">
                                            <div class="section-title">
                                                <h5 class=""><?php echo get_sub_field('title'); ?></h5>
                                            </div>
...
<section  class="partner-area py-5 clearfix">
    <?php if (have_rows('analysis')) : while (have_rows('analysis')) : the_row(); ?>
        <div class="container py-md-4">
            <div class="section-title mb-4 text-center">
                <div class="line mb-4"></div>
                <h2 class="mb-4"><?php echo get_sub_field('title'); ?></h2>
