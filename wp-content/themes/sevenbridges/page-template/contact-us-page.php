	...
	<div class="container">
		...
		<div class="row  g-4 pt-4">
			<div class="col-lg-7 col-md-7">
				<h1 class="text-white"style="margin-top: 120px;"><?php echo get_field('banner')['title']; ?><b></b></h1>
                <?php if (have_rows('content')) : while (have_rows('content')) : the_row(); ?>

                    <h4 class="mb-4" style="margin-top: 100px; color: #174C75;"><b><?php echo get_sub_field('title'); ?></b></h4>
                    <h5 class="mb-4" style=" color: #174C75;"><b><?php echo get_sub_field('title_1'); ?></b></h5>
                    <div class="row mb-5">
                    ...
                    <h5 class="mb-5" style=" color: #174C75;"><b><?php echo get_sub_field('sub_heading'); ?></b></h5>
