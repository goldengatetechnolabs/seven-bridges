...
<section  class="py-5 clearfix">
    <?php if (have_rows('content')) : while (have_rows('content')) : the_row(); ?>
        <div class="container py-md-4">
            <div class="section-title mb-5 col-md-8 mx-auto text-center  wow fadeInUp" data-wow-delay=".3s">
                <div class="line mb-4"></div>
                <h2 class="mb-4"><?php echo get_sub_field('title'); ?></h2>
                <p class="mb-4 "><?php echo get_sub_field('description'); ?></p>
            </div>
...
<section  class="bg-f4 py-5 clearfix">
    <?php if (have_rows('content_1')) : while (have_rows('content_1')) : the_row(); ?>
        <div class="container py-md-4">
            ...
            <div class="row g-4 wow fadeInUp pt-md-5" data-wow-delay=".5s">
                <?php if (have_rows('card')) : while (have_rows('card')) : the_row(); ?>
                    <div class="col-md-4">
                        <div class="exp-block">
...
<?php if(get_field("customers")["show_this_section"] == "Yes"){ ?>
...
<?php }?>
<!-- Case Study  -->
<?php if(get_field("case_study")["show_this_section"] == "Yes"){ ?>
