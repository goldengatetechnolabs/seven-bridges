...
<section  class="nn-sect py-5 clearfix">
	<div class="container py-md-4">
        <div class="row g-4" style="padding-left: 150px; padding-right: 150px;">
            <div class="col-lg-12 col-md-12 col-sm-12 mb-4">
				...
				<h4 class="mb-4" style="color: #174C75;"><b><?php echo the_title(); ?></b></h4>
                <?php echo the_content(); ?>
            </div><hr>
			<div class="row mt-4 mb-4">
				<div class="col-lg-6 col-md-6" style="font-weight: bold;font-style: normal;">
				...
				<div class="col-lg-3 col-md-3" style="font-weight: bold;font-style: normal;">
